...
file="/WEB-INF/views/includes/header.jsp" %> <%@ taglib prefix="fn"
...
<c:out value="${board.content}"/></textarea
                ...
                <div class="float-end">
                    ...
                    <c:if
                        test="${!board.delFlag && (secInfo.uid == board.writer || fn:contains(roles, 'ROLE_ADMIN'))}"
                    >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="replyModForm">
                    ...
                    <div class="mb-3">
                        <label for="replyText" class="form-label"
                            >댓글 내용</label
                        >
                        <input
                            type="text"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btnReplyMod">
                    수정
                </button>
                <button type="button" class="btn btn-danger btnReplyDel">
                    삭제
                </button>
                <button
                    type="button"
...
<script>
    ...
    const replyModal = new bootstrap.Modal(
        document.querySelector("#replyModal")
    );
        ...
        (e) => {
            ...
            axios.get(`/replies/\${rno}`).then((res) => {
                ...
                if (targetReply.delflag === false) {
                    replyModForm.querySelector(
                        "input[name = 'rno']"
                    ).value = targetReply.rno;
                    replyModForm.querySelector(
                        "input[name = 'replyText']"
                    ).value = targetReply.replyText;
